...
export const generateCsp: GenerateCsp<JsLoaderImportDependencies> = (widgetUrl, { apiUrl }) =>
  getCSP({
    directives: {
      "connect-src": [apiUrl.origin, `https://${widgetUrl.hostname}:*`, `wss://${widgetUrl.hostname}:*`],
